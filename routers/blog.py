...
from models import TopicRequest, TopicResponse, KeywordOutlineRequest, KeywordOutlineResponse, GenerateBlogRequest, GenerateBlogResponse
...
@blog_router.post("/generate-topics", response_model=TopicResponse)
...
@blog_router.post("/generate-outline", response_model=KeywordOutlineResponse)
...
@blog_router.post("/generate-blog", response_model=GenerateBlogResponse)
